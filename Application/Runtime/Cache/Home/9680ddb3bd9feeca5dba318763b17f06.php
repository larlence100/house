...
<body >
	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray">
			<span class="l">
				<?php if(($_SESSION["_ACCESS_LIST"]["HOME"]["RBAC"]["ADDROLE"]) or ($_SESSION["superadmin"])): ?><a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','<?php echo U('Rbac/addRole');?>','600','400')">
		...
		<table class="table table-border table-bordered table-hover table-bg">
			...
			<tbody id="xsjjs">
				<?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
						<td><?php echo ($i+$firstRow); ?></td>
						<td><?php echo ($v["name"]); ?></td>
						<td><a href="#"><?php echo ($v["remark"]); ?></a></td>
						<td>
							<?php if($v["status"]): ?>开启
							<?php else: ?>
								关闭<?php endif; ?>
						...
						<td class="f-14">
							<a title="编辑" href="javascript:;" onclick="admin_role_add('角色编辑','<?php echo U('Rbac/editRole',array('id'=>$v['id']));?>','600','400')" style="text-decoration:none">
								<i class="Hui-iconfont" style="font-size: 18px;">&#xe6df;</i>
							</a>
							<?php if($v["id"] != 1): ?><a title="删除" href="javascript:;" onclick="admin_role_del(this,'<?php echo ($v["id"]); ?>')" class="ml-5" style="text-decoration:none">
