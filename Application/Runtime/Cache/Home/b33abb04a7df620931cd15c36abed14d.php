...
<body >
	...
	<nav class="breadcrumb hidden">
		...
		<span class="c-gray en">&gt;</span> 钥匙管理
	...
	<div class="page-container">
		<table id="table" class="table table-border table-bordered table-hover table-bg">
			...
			<tbody id="tbody">
				<?php if(is_array($fangyuan)): $i = 0; $__LIST__ = $fangyuan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fy): $mod = ($i % 2 );++$i;?><tr class="text-c" data-href="">
						<td><?php echo ($i+$firstRow); ?></td>
						<td>
							<?php if(is_array($xingzhengqu)): foreach($xingzhengqu as $key=>$xzq): if($fy["xingzhengqu"] == $xzq["id"]): echo ($xzq["xzqming"]); endif; endforeach; endif; ?>
						</td>
						<td>
							<?php if(is_array($pianqu)): foreach($pianqu as $key=>$pq): if($fy["pianqu"] == $pq["id"]): echo ($pq["pianqum"]); endif; endforeach; endif; ?>
						</td>
						<td><?php echo ($fy["xiaoqum"]); ?></td>
						<td><?php echo ($fy["zuodong"]); ?></td>
						<td><?php echo ($fy["danyuan"]); ?></td>
						<td><?php echo ($fy["fanghao"]); ?></td>
						<td id="td">
						...
						<td>
							<?php if(is_array($bumen)): foreach($bumen as $key=>$bm): if($fy["shouyaobm"] == $bm["id"]): echo ($bm["bmming"]); endif; endforeach; endif; ?>
						</td>
						<td>
							<?php if(is_array($yonghu)): foreach($yonghu as $key=>$yh): if($fy["shouyaoren"] == $yh["id"]): echo ($yh["ygmingcheng"]); endif; endforeach; endif; ?>
						</td>
						<td>YS<?php echo ($fy["bianhao"]); ?></td>
