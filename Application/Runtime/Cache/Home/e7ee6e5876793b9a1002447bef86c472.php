...
<body >
	...
	<article class="page-container"  style="margin-top: 10px;">
		...
		<form action="/kaidandashi/index.php/home/ziyuan/addxzqHandle" method="post" class="form form-horizontal" id="form-admin-xzq-add">
			<br/>
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" class="input-text" value="" placeholder="" id="xzqming" name="xzqming" required="required">
					</div>
				</div>
			</div>
