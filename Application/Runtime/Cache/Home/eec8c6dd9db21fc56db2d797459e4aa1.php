...
<body >
    ...
    <div class="layui-input-block" style="margin-left: 0px;">
      <button class="layui-btn layui-btn-radius" onClick="parent.layer.close(parent.layer.getFrameIndex(window.name));" >关闭</button>
    </div>
  </div>
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            accept: {
                 title: 'Images',
                 extensions: 'gif,jpg,JPG,jpeg,bmp,png',
                 mimeTypes: 'image/gif,image/jpg,image/JPG,image/jpeg,image/bmp,image/png'
            },
        ...
        //初始化以后添加传值
        uploader.options.formData.fybh = <?php echo ($_GET['fybh']); ?>;
