...
<body >
	...
	<article class="page-container">
		<form action="/index.php/home/rbac/editBumenHandle" method="post" class="form form-horizontal" id="form-admin-pianqu-edit">
			...
			<div class="col-xs-12 col-sm-12">
				<div class="row cl">
					...
					<div class="formControls col-xs-5">
						<input type="text" class="input-text" value="<?php echo ($bm['bmming']); ?>" placeholder="" id="pianqum" name="bmming">
					</div>
				</div>
				<br/>
				<div class="row cl">
					...
					<div class="formControls col-xs-5">
						<select nullmsg="请选择负责人" datatype=""  id="" name="bmfuzerenid" size="1" class="input-text radius">
							<?php if(is_array($yonghu)): foreach($yonghu as $key=>$yh): ?><option style="display:none">请选择负责人</option>
	                			<option value="<?php echo ($yh["id"]); ?>" <?php if($bm['bmfuzerenid'] == $yh['id']): ?>selected = "selected"<?php endif; ?>><?php echo ($yh["ygmingcheng"]); ?></option><?php endforeach; endif; ?>
	              		</select>
					</div>
				</div>
				<br/>
				<div class="row cl">
					...
					<div class="formControls col-xs-5">
						<input type="text" class="input-text" value="<?php echo ($bm['bmdianhua']); ?>" placeholder="" id="" name="bmdianhua">
					</div>
				</div>
				<br/>
				<div class="row cl">
					...
					<div class="formControls col-xs-5">
						<input type="text" class="input-text" value="<?php echo ($bm['bmdizhi']); ?>" placeholder="" id="" name="bmdizhi">
					</div>
				</div>
			</div>
