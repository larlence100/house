...
function layer_show_big(title,url){
...
$(function(){
	...
	$(".Hui-aside").on("click",".menu_dropdown ul li a",function(){
		if($(window).width()<768){
			$(".Hui-aside").slideToggle();
		}
	});
	...
	/*选项卡导航*/
	$(".navbar-wrapper").on("click","#daohang a",function(){
		Hui_admin_tab(this);
	});
